...
<html lang="en-US">
   ...
   <body>
      ...
      <section class="single-candidate-page section_70 job_dtl_top_sec">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12">
                  <div class="single-candidate-action">
                     <a href="#" class="candidate-contact">Budget $30-250 USD</a>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="col-md-8 col-lg-9">
                  <div class="single-candidate-bottom-left">
                     <div class="single-candidate-widget">
                        <h3>Skills:<small> CSS, HTML, Javascript, Linux, PHP</small></h3>
                        ...
                        <div class="sidebar-list-single">
                           <div class="top-company-list">
                              ...
                              <div class="company-list-details">
                                 ...
                                 <p class="varify"><i class="fa fa-check"></i>Last Bidding : $1200</p>
                              </div>
                        ...
                        <div class="sidebar-list-single">
                           <div class="top-company-list">
                              ...
                              <div class="company-list-details">
                                 ...
                                 <p class="company-state"><i class="fa fa-map-marker"></i> Chicago, Michigan</p>
                                 <p class="open-icon"><i class="fa fa-clock-o"></i>2 minutes ago</p>
                                 <p class="varify"><i class="fa fa-check"></i>Last Bidding : $800</p>
                              </div>
                              <div class="company-list-btn">
                                 <a href="#" class="jobguru-btn">bid now</a>
                              </div>
					...
					<div class="single-candidate-widget-2"> 
					 ...
					 <div class="single-candidate-widget-2">
						...
						<ul class="job-overview">
                            <h4>Job Details</h4>
						   <li>
                              <h4><i class="fa fa-user"></i> Member since</h4>
                              <p>May 2019</p>
                           </li>
						   <li>
                           ...
                           <li>
                              <h4><i class="fa fa-thumb-tack"></i> Category</h4>
                              <p>Web design</p>
							  <!-- <span class="pull-right small">Full Time</span> -->
                           </li>
                           <li>
						   ...
						   <li>
                              <h4><i class="fa fa-exclamation-triangle"></i> Deliver Within</h4>
                              <p>5 days</p>
                           </li>
                        </ul>
                     </div>
					 ...
					 <div class="blog-sidebar-widget">
                        ...
                        <ul class="blog-categories">
                           <li>
                              ...
                              Webdesign <span>(23)</span>
                              </a>
                           </li>
                           <li>
                              <a href="#">
                              <i class="fa fa-angle-double-right "></i>
                              Mobile App Design <span>(12)</span>
                              </a>
                           </li>
                           <li>
                              <a href="#">
                           ...
                           <li>
                              <a href="#">
                              <i class="fa fa-angle-double-right "></i>
                              Lorem ipsum <span>(32)</span>
                              </a>
                           </li>
                           <li>
                              <a href="#">
                              <i class="fa fa-angle-double-right "></i>
                              Lorem ipsum <span>(11)</span>
                              </a>
                           </li>
